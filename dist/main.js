...
electron__WEBPACK_IMPORTED_MODULE_1__.ipcMain.handle('UnRedo-action', (event, payload) => {
    try {
...
electron__WEBPACK_IMPORTED_MODULE_1__.ipcMain.handle('load-URL', (event, ImageURL) => {
    try {
...
electron__WEBPACK_IMPORTED_MODULE_1__.ipcMain.on('show-error', (event, title, message) => {
    const focusedWindow = electron__WEBPACK_IMPORTED_MODULE_1__.BrowserWindow.getFocusedWindow();
    if (!focusedWindow)
        return;
    electron__WEBPACK_IMPORTED_MODULE_1__.dialog.showMessageBox(focusedWindow, {
        type: 'error',
        title: title,
        message: message,
        buttons: ['OK'],
